...
import com.example.listkampus.DetailActivity
import com.example.listkampus.R
import com.example.listkampus.University
...
class ListUniversityAdapter(private val listUniversity: ArrayList<University>) : RecyclerView.Adapter<ListUniversityAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, description, photo, web) = listUniversity[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            intentDetail.putExtra("extra_university", listUniversity[holder.adapterPosition])
